...
translations = {
    'es': {
        # ==========================================
        # TEXTOS COMUNES (Header y Footer)
        # ==========================================
        'common': {
        ...
        # ==========================================
        'soluciones': {
            'hero_title': 'Tecnología que <br><span class="text-accent">Redefine el Territorio</span>',
            'hero_desc': 'Desde la generación de planos por IA hasta el análisis masivo de datos urbanos. Respuestas inteligentes para un mundo geolocalizado.',
            
            'sol1_badge': 'Gobierno & Smart Cities',
            'sol1_title': 'Análisis Geoespacial Conversacional',
            'sol1_desc': 'Plataforma B2G diseñada para la gobernanza moderna. Ejecute análisis complejos de accesibilidad y "Ciudades de 15 minutos" mediante una interfaz de lenguaje natural intuitiva y potente.',
            'sol1_feat1': '<strong class="text-black">Interfaz Natural:</strong> Consultas GIS sin necesidad de conocimientos técnicos previos.',
            'sol1_feat2': '<strong class="text-black">Accesibilidad Urbana:</strong> Monitorización de proximidad y movilidad ciudadana.',
            
            'sol2_badge': 'Inteligencia Artificial',
            'sol2_title': 'Planificador Inteligente',
            'sol2_desc': 'Optimización del diseño territorial mediante IA generativa. Convierte imágenes satelitales en planos profesionales de forma instantánea, facilitando la toma de decisiones en sectores B2B y B2C.',
            'sol2_feat1': 'Eficiencia Operativa',
            'sol2_feat2': 'Precisión Técnica',
            
            'sol3_badge': 'Real Estate',
            'sol3_title': 'Captación y Análisis de Activos',
            'sol3_desc': 'Visualización avanzada de datos georeferenciados para el sector inmobiliario. Nuestro visor analiza servicios, transporte y demografía del entorno para fortalecer los argumentos de captación y venta.',
            'sol3_box1_title': 'Visor de Entorno',
            'sol3_box1_desc': 'Análisis detallado de servicios para cierre de ventas.',
            'sol3_box2_title': 'Lead Capture',
            'sol3_box2_desc': 'Captación de datos con precisión geográfica.',
            'sol3_note': '* Módulos independientes o solución integral'
        },

        'producto': {
            'hero_title': 'El territorio responde a <br><span class="text-accent">tus preguntas</span>',
            'hero_desc': 'SmartGIS combina datos espaciales con el poder de la IA conversacional para que cualquier técnico municipal pueda analizar su ciudad en segundos.',
            ...
            'feat_desc': 'Nuestra herramienta insignia permite a los ayuntamientos calcular indicadores de proximidad automáticamente. Evalúa el acceso a educación, salud y servicios esenciales con un solo clic.',
            'feat_check1': 'Isócronas de tiempo real (Peatón, Bici, Bus)',
            'feat_check2': 'Identificación de desiertos de servicios',
            'feat_check3': 'Análisis demográfico por área de influencia',
            'card1_title': 'Motor Gemini AI',
            'card1_desc': 'Utilizamos modelos avanzados de lenguaje para transformar frases naturales en complejas consultas SQL geoespaciales sobre PostGIS.',
            ...
            'card3_desc': 'Genera automáticamente PDFs con mapas, gráficos y conclusiones clave listos para ser presentados en comisiones municipales.'
        },
    ...
    'ca': {
        ...
        # ==========================================
        'soluciones': {
            'hero_title': 'Tecnologia que <br><span class="text-accent">Redefineix el Territori</span>',
            'hero_desc': 'Des de la generació de plànols per IA fins a l\'anàlisi massiu de dades urbanes. Respostes intel·ligents per a un món geolocalitzat.',
            
            'sol1_badge': 'Govern & Smart Cities',
            'sol1_title': 'Anàlisi Geoespacial Conversacional',
            'sol1_desc': 'Plataforma B2G dissenyada per a la governança moderna. Executi anàlisis complexos d\'accessibilitat i "Ciutats de 15 minuts" mitjançant una interfície de llenguatge natural intuïtiva i potent.',
            'sol1_feat1': '<strong class="text-black">Interfície Natural:</strong> Consultes GIS sense necessitat de coneixements tècnics previs.',
            'sol1_feat2': '<strong class="text-black">Accessibilitat Urbana:</strong> Monitoratge de proximitat i mobilitat ciutadana.',
            
            'sol2_badge': 'Intel·ligència Artificial',
            'sol2_title': 'Planificador Intel·ligent',
            'sol2_desc': 'Optimització del disseny territorial mitjançant IA generativa. Converteix imatges satel·litàries en plànols professionals de forma instantània, facilitant la presa de decisions en sectors B2B i B2C.',
            'sol2_feat1': 'Eficiència Operativa',
            'sol2_feat2': 'Precisió Tècnica',
            
            'sol3_badge': 'Real Estate',
            'sol3_title': 'Captació i Anàlisi d\'Actius',
            'sol3_desc': 'Visualització avançada de dades georeferenciades per al sector immobiliari. El nostre visor analitza serveis, transport i demografia de l\'entorn per enfortir els arguments de captació i venda.',
            'sol3_box1_title': 'Visor d\'Entorn',
            'sol3_box1_desc': 'Anàlisi detallada de serveis per al tancament de vendes.',
            'sol3_box2_title': 'Lead Capture',
            'sol3_box2_desc': 'Captació de dades amb precisió geogràfica.',
            'sol3_note': '* Mòduls independents o solució integral'
        },

        'producto': {
            'hero_title': 'El territori respon a les <br><span class="text-accent">teves preguntes</span>',
            'hero_desc': 'SmartGIS combina dades espacials amb el poder de la IA conversacional perquè qualsevol tècnic municipal pugui analitzar la seva ciutat en segons.',
            ...
            'feat_desc': 'La nostra eina insígnia permet als ajuntaments calcular indicadors de proximitat automàticament. Avalua l\'accés a educació, salut i serveis essencials amb un sol clic.',
            'feat_check1': 'Isòcrones de temps real (Vianant, Bici, Bus)',
            'feat_check2': 'Identificació de deserts de serveis',
            'feat_check3': 'Anàlisi demogràfica per àrea d\'influència',
            'card1_title': 'Motor Gemini AI',
            'card1_desc': 'Utilitzem models avançats de llenguatge per transformar frases naturals en complexes consultes SQL geoespacials sobre PostGIS.',
            ...
            'card3_desc': 'Genera automàticament PDFs amb mapes, gràfics i conclusions clau llestos per ser presentats en comissions municipals.'
        },
